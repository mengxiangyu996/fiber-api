...
// 将字符串解析为时间
func ParseTime(value string) (Date, error) {

	date, err := time.ParseInLocation("15:04:05", value, time.Local)

	return Date{Time: date}, err
}

// 将字符串解析为时间
func ParseTimeInLocation(value string, location *time.Location) (Date, error) {

	date, err := time.ParseInLocation("15:04:05", value, location)
...
// 将字符串解析为日期时间
func ParseDatetimeInLocation(value string, location *time.Location) (Time, error) {
